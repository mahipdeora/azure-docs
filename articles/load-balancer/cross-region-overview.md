...
:::image type="content" source="./media/global-overview/global-load-balancer.png" alt-text="Diagram of global load balancer." border="true":::
...
:::image type="content" source="./media/global-overview/global-region-view.png" alt-text="Diagram of global region traffic view." border="true":::
...
:::image type="content" source="./media/global-overview/multiple-region-global-traffic.png" alt-text="Diagram of multiple region global traffic.":::
...
- See [Tutorial: Create a global load balancer using the Azure portal](tutorial-global-portal.md) to create a global load balancer.
